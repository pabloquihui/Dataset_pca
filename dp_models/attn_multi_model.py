...
########################################################################################################
#Attention U-Net
def att_unet(img_h, img_w, img_ch, n_label, data_format='channels_last'):
    inputs = Input((img_h,img_w, img_ch))
    x = inputs
    depth = 4
    features = 16
...
########################################################################################################
#Attention U-Net with Montecarlo Dropout
def mc_att_unet(img_h, img_w, img_ch, n_label, data_format='channels_last'):
    inputs = Input((img_h,img_w, img_ch))
    x = inputs
    depth = 4
    features = 16
...
########################################################################################################
#Recurrent Residual Convolutional Neural Network based on U-Net (R2U-Net)
def r2_unet(img_h, img_w, img_ch, n_label, data_format='channels_last'):
    inputs = Input((img_h,img_w, img_ch))
    x = inputs
    depth = 4
    features = 16
...
########################################################################################################
#Attention R2U-Net
def att_r2_unet(img_h, img_w, img_ch, n_label, data_format='channels_last'):
    inputs = Input((img_h,img_w, img_ch))
    x = inputs
    depth = 4
    features = 16
